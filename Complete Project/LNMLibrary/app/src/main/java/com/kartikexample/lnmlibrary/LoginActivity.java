...
public class LoginActivity extends Activity {
   ...
   // private UserLoginTask mAuthTask = null;
    ...
    public static String input,useridinput;
    Button signin;
    ...
    public static void setUseridinput(String useridinput) {
        LoginActivity.useridinput = useridinput;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parse.initialize(this, "KO26kO9NafMPQrZ5OV2rVdt3JWbtBCIztsJPZYWx", "98BqcQ6MjIukaXUzLo4EOHwLOg5DdNSbB63evxJu");
        ...
        signin.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
               ...
               setUseridinput(useridView.getText().toString());
               /* if(getInput().equals("admin")) {
                ...
                query.whereEqualTo("userPassword", password);
                query.getFirstInBackground(new GetCallback<ParseObject>() {
                    public void done(ParseObject object, ParseException e) {
                        if (object == null) {
                            ...
                            if (object.getString("userType").equalsIgnoreCase("faculty")) {
                                input = "faculty";
                                Intent intent = new Intent(LoginActivity.this, Navi_draw_faculty.class);
                                startActivity(intent);
                            }
                            if (object.getString("userType").equalsIgnoreCase("student") || object.getString("userType").equalsIgnoreCase("staff")) {
                                input = "user";
                                Intent intent = new Intent(LoginActivity.this, Navi_draw_user.class);
                                startActivity(intent);
                            }
                        }
                    }
