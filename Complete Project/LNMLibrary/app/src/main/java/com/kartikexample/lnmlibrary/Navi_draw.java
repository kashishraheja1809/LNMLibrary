...
public class Navi_draw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Navi_draw.this, mPlanetTitles[position] + " is selected", Toast.LENGTH_LONG).show();
                //Intent intent_home = new Intent (this, Navi_draw.class);
                if(position==0)
                {
                    Intent intent_home = new Intent (Navi_draw.this, Navi_draw.class);
                    startActivity(intent_home);
                }
                if(position == 1)
                {
                    Intent intent_search = new Intent(Navi_draw.this, SearchActivity.class);
                    startActivity(intent_search);
                }
                else if(position == 2)
                {
                    Intent intent_pro = new Intent(Navi_draw.this, SearchActivity.class);
                    startActivity(intent_pro);
                }
                else if(position == 3)
                {
                    Intent intent_noti = new Intent(Navi_draw.this, SearchActivity.class);
                    startActivity(intent_noti);
                }
                else if(position == 4)
                {
                    Intent intent_noti = new Intent(Navi_draw.this, TransactionActivity.class);
                    startActivity(intent_noti);
                }
                else if(position == 5)
                {
                    Intent intent_book_data = new Intent(Navi_draw.this, Admin_NewBookActivity.class);
                    startActivity(intent_book_data);
                }
                else if(position == 6)
                {
                    Intent intent_en_user = new Intent(Navi_draw.this, Admin_UserEnrollActivity.class);
                    startActivity(intent_en_user);
                }
                else if(position == 7)
                {
                    Intent intent_pur = new Intent(Navi_draw.this, SearchActivity.class);
                    startActivity(intent_pur);
                }
                else if(position == 8)
                {
                    Intent intent_ch_pass = new Intent(Navi_draw.this, ChangePassword.class);
                    startActivity(intent_ch_pass);
                }
                else if(position == 9)
                {
                        Intent intent_logout = new Intent(Navi_draw.this, LoginActivity.class);
